...
int Map::remove() {                                                            //消除整行并返回消除行数,只需判断最后四个添加到blocks里的元素
    ...
    switch(ans) {
    case 1:
        g->line_clear->setMedia
               (QUrl("qrc:/new/prefix1/QT resourse/SEB_mino1.wav"));
        g->line_clear->play();
        break;
    case 2:
        g->line_clear->setMedia
                (QUrl("qrc:/new/prefix1/QT resourse/SEB_mino2.wav"));
        g->line_clear->play();
        break;
    case 3:
        g->line_clear->setMedia
                (QUrl("qrc:/new/prefix1/QT resourse/SEB_mino3.wav"));
        g->line_clear->play();
        break;
    case 4:
        g->line_clear->setMedia
                (QUrl("qrc:/new/prefix1/QT resourse/SEB_mino4.wav"));
        g->line_clear->play();
        break;
    }
    return ans;
